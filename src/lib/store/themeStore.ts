...
export const BUILTIN_PALETTES: ColorPalette[] = [
  ...
  // ─── 6 Professional Blue Palette Suite ───────────────────────────
  {
    ...
    bg: "#EFF6FF",
    sidebarType: "dark",
    sidebarBg: "linear-gradient(180deg, #061933 0%, #0B2D5B 100%)",
    sidebarText: "rgba(255, 255, 255, 0.9)",
    sidebarBorder: "rgba(59, 130, 246, 0.22)",
    headingColor: "#0B2D5B",
    headerBg: "#FFFFFF",
    debitColor: "#0B2D5B",
    creditColor: "#1E4FA3",
  ...
  },
  {
    ...
    bg: "#F8FAFC",
    sidebarType: "dark",
    sidebarBg: "linear-gradient(180deg, #0A1B31 0%, #0F2747 100%)",
    sidebarText: "rgba(255, 255, 255, 0.9)",
    sidebarBorder: "rgba(37, 99, 235, 0.22)",
    headingColor: "#0F2747",
    headerBg: "#FFFFFF",
    debitColor: "#0F2747",
    creditColor: "#2563EB",
  ...
  },
  {
    ...
    bg: "#F0F9FF",
    sidebarType: "dark",
    sidebarBg: "linear-gradient(180deg, #06283D 0%, #0C4A6E 100%)",
    sidebarText: "rgba(255, 255, 255, 0.9)",
    sidebarBorder: "rgba(14, 165, 233, 0.22)",
    headingColor: "#0C4A6E",
    headerBg: "#FFFFFF",
    debitColor: "#0C4A6E",
    creditColor: "#0284C7",
  ...
  },
  {
    ...
    bg: "#EFF6FF",
    sidebarType: "dark",
    sidebarBg: "linear-gradient(180deg, #051525 0%, #0A2540 100%)",
    sidebarText: "rgba(255, 255, 255, 0.9)",
    sidebarBorder: "rgba(37, 99, 235, 0.22)",
    headingColor: "#0A2540",
    headerBg: "#FFFFFF",
  ...
  },
  {
    ...
    bg: "#F0F9FF",
    sidebarType: "dark",
    sidebarBg: "linear-gradient(180deg, #0F1E4A 0%, #1E3A8A 100%)",
    sidebarText: "rgba(255, 255, 255, 0.9)",
    sidebarBorder: "rgba(14, 165, 233, 0.22)",
    headingColor: "#1E3A8A",
    headerBg: "#FFFFFF",
  ...
  },
  {
    ...
    bg: "#F8FAFF",
    sidebarType: "dark",
    sidebarBg: "linear-gradient(180deg, #0F2158 0%, #1E40AF 100%)",
    sidebarText: "rgba(255, 255, 255, 0.9)",
    sidebarBorder: "rgba(96, 165, 250, 0.22)",
    headingColor: "#1E40AF",
    headerBg: "#FFFFFF",
    debitColor: "#1E40AF",
    creditColor: "#3B82F6",
