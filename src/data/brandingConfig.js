...
export const COLOR_PALETTES = [
  ...
  /* ── 6 Professional Blue Palette Suite ── */
  {
    id: 'pro-blue-default',
    name: 'Professional Blue (Default ERP)',
    subtitle: 'OPTION 1',
    tag: 'Recommended',
    description: 'Clean, modern and professional. Suitable for most enterprise ERP systems.',
    swatches: ['#0B2D5B', '#1E4FA3', '#3B82F6', '#60A5FA', '#EFF6FF'],
    previewItem: {
    ...
    vars: {
      ...
      '--border-input':       '#BFDBFE',
      '--text-main':          '#0B2D5B',
      '--text-secondary':     '#1E4FA3',
      '--text-muted':         '#64748B',
      '--text-sidebar':       'rgba(255, 255, 255, 0.9)',
      '--text-sidebar-hover': '#60A5FA',
      '--text-logo':          '#0B2D5B',
      '--bg-sidebar-hover':   '#153A6D',
      '--finance-blue':       '#0B2D5B',
      '--color-primary':      '#0B2D5B',
      '--color-accent':       '#3B82F6',
      '--color-debit':        '#0B2D5B',
      '--color-credit':       '#1E4FA3',
      '--heading-color':      '#0B2D5B',
      '--sidebar-bg':         'linear-gradient(180deg, #061933 0%, #0B2D5B 100%)',
    },
  },

  {
    id: 'corporate-blue-slate',
    name: 'Corporate Blue & Slate',
    subtitle: 'OPTION 2',
    tag: 'Business Ready',
    description: 'Traditional, trustworthy and polished. Great for finance, HR and administration modules.',
    swatches: ['#0F2747', '#2563EB', '#3B82F6', '#94A3B8', '#F8FAFC'],
    previewItem: {
    ...
    vars: {
      ...
      '--text-sidebar-hover': '#3B82F6',
      '--text-logo':          '#0F2747',
      '--bg-sidebar-hover':   '#1B3B66',
      '--finance-blue':       '#0F2747',
      '--color-primary':      '#0F2747',
      '--color-accent':       '#3B82F6',
      '--color-debit':        '#0F2747',
      '--color-credit':       '#2563EB',
      '--heading-color':      '#0F2747',
      '--sidebar-bg':         'linear-gradient(180deg, #0A1B31 0%, #0F2747 100%)',
    },
  },

  {
    ...
    subtitle: 'OPTION 3',
    tag: 'Modern & Clean',
    description: 'Fresh, modern and clean. Good for cloud based ERP systems.',
    swatches: ['#0C4A6E', '#0284C7', '#0EA5E9', '#38BDF8', '#F0F9FF'],
    previewItem: {
      title: 'Cloud Billing & Dispatch',
      badge: 'Cloud Sync',
      amount: 'Rs. 14,20,500',
    ...
    vars: {
      ...
      '--sidebar-bg':         'linear-gradient(180deg, #06283D 0%, #0C4A6E 100%)',
    },
  },

  {
    ...
    description: 'Professional with deeper tones. Suitable for large enterprise environments.',
    swatches: ['#0A2540', '#1E3A8A', '#2563EB', '#60A5FA', '#EFF6FF'],
    previewItem: {
      title: 'Enterprise Multi-Branch Consolidation',
      badge: 'Consolidated',
      amount: 'Rs. 9,75,40,000',
      button: 'View Balance Sheet',
    },
    vars: {
      '--primary':            '#0A2540',
      '--primary-mid':        '#1E3A8A',
      '--primary-light':      '#EFF6FF',
      '--primary-hover':      '#06182B',
      '--accent-blue':        '#2563EB',
      '--accent':             '#2563EB',
      '--bg-layout':          '#EFF6FF',
      '--bg-app':             '#EFF6FF',
      ...
      '--sidebar-bg':         'linear-gradient(180deg, #051525 0%, #0A2540 100%)',
    },
  },

  {
    id: 'blue-gradient-suite',
    name: 'Blue Gradient Suite',
    subtitle: 'OPTION 5',
    tag: 'Modern & Vibrant',
    description: 'Modern and vibrant. Works well for dashboards and analytics heavy ERP systems.',
    swatches: ['#1E3A8A', '#3B82F6', '#0EA5E9', '#22D3EE', '#F0F9FF'],
    previewItem: {
      title: 'Predictive Cash Runway Radar',
      badge: 'Real-Time',
      amount: 'Rs. 72,15,000',
    ...
    vars: {
      ...
      '--text-muted':         '#64748B',
      '--text-sidebar':       'rgba(255, 255, 255, 0.9)',
      '--text-sidebar-hover': '#22D3EE',
      '--text-logo':          '#1E3A8A',
      '--bg-sidebar-hover':   '#284CB0',
      '--finance-blue':       '#1E3A8A',
      ...
      '--sidebar-bg':         'linear-gradient(180deg, #0F1E4A 0%, #1E3A8A 100%)',
    },
  },

  {
    id: 'soft-blue-minimal',
    name: 'Soft Blue Minimal',
    subtitle: 'OPTION 6',
    tag: 'Minimal & Elegant',
    description: 'Subtle and elegant. Good for clean and minimal ERP interface.',
    swatches: ['#1E40AF', '#3B82F6', '#60A5FA', '#93C5FD', '#F8FAFF'],
    previewItem: {
      title: 'Fixed Asset Depreciations',
      badge: 'Audited',
      amount: 'Rs. 31,50,000',
      button: 'Post Schedule',
    },
    vars: {
      '--primary':            '#1E40AF',
      '--primary-mid':        '#2563EB',
      ...
      '--text-muted':         '#64748B',
      '--text-sidebar':       'rgba(255, 255, 255, 0.9)',
      '--text-sidebar-hover': '#93C5FD',
      '--text-logo':          '#1E40AF',
      '--bg-sidebar-hover':   '#2851D6',
      '--finance-blue':       '#1E40AF',
      ...
      '--sidebar-bg':         'linear-gradient(180deg, #0F2158 0%, #1E40AF 100%)',
    },
  },
