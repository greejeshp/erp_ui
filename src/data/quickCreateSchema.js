...
export const QUICK_CREATE_CATEGORIES = [
  {
    label: 'GENERAL',
    items: [
      { href: '/Account/Creation/Ledger',           title: 'Ledger' },
      { href: '/Account/Creation/LedgerGroup',      title: 'Ledger Group' },
      { href: '/Account/Creation/SalesMan',         title: 'Salesman' },
      { href: '/Account/Creation/AreaMaster',       title: 'Area Master' },
      { href: '/Account/Creation/Bank',             title: 'Bank' },
      { href: '/Account/Creation/Currency',         title: 'Currency' },
      { href: '/Account/Creation/Department',       title: 'Department' },
      { href: '/Account/Creation/PaymentTerms',     title: 'Payment Terms' },
      { href: '/Account/Creation/PaymentMode',      title: 'Payment Mode' },
      { href: '/Setup/Security/EntityProperties',    title: 'Entity Properties' },
    ],
  },
  {
    label: 'INVENTORY',
    items: [
      { href: '/Inventory/Creation/Product',           title: 'Product' },
      { href: '/Inventory/Creation/ProductGroup',      title: 'Product Group' },
      { href: '/Inventory/Creation/ProductCompany',    title: 'Product Company' },
      { href: '/Inventory/Creation/ProductCategories', title: 'Product Category' },
      { href: '/Inventory/Creation/ProductBrand',      title: 'Product Brand' },
      { href: '/Inventory/Creation/Unit',              title: 'Product Unit' },
      { href: '/Inventory/Creation/Godown',            title: 'Godown' },
    ],
  },
  {
    label: 'ACCOUNTING',
    items: [
      { href: '/Account/Transaction/Receipt',       title: 'Receipt' },
      { href: '/Account/Transaction/Payment',       title: 'Payment' },
      { href: '/Account/Transaction/Journal',       title: 'Journal' },
      { href: '/Account/Transaction/Contra',        title: 'Contra' },
      { href: '/Account/Creation/VoucherMode',      title: 'Voucher Mode' },
      { href: '/Account/Creation/NarrationMaster',  title: 'Narration' },
      { href: '/Account/Creation/LedgerCategory',   title: 'Ledger Category' },
    ],
  },
  {
    label: 'OPERATIONS',
    items: [
      { href: '/AssetsManagement/Creation/AssetsMaster', title: 'Asset' },
      { href: '/AssetsManagement/Creation/AssetGroup',   title: 'Asset Group' },
      { href: '/Task/Creation/CreateTask',               title: 'Task' },
      { href: '/Support/Creation/CreateTicket',          title: 'Support Ticket' },
      { href: '/service/techtran/devicetype',            title: 'Device Type' },
      { href: '/Service/Creation/JobType',               title: 'Job Type' },
    ],
  },
];
